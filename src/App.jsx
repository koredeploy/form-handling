  ...
  return (
    <div className=" w-11/12 lg:w-[70%] mx-auto my-12 items-center grid grid-cols-1 lg:grid-cols-2 gap-20">
      ...
      <div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="relative flex flex-col gap-4 bg-white p-9 rounded-md shadow-lg">
        ...
        <input
            ...
            type="text"
          />
         {errors.firstname && <img className="  w-5 h-5 -translate-y-8 absolute right-5" src={errorIcon} alt="" />}
        </div>
      ...
      <input
            ...
            type="text"
          />
            {errors.lastname && <img className=" w-5 h-5 -translate-y-8 absolute right-5 " src={errorIcon} alt="" />}
      </div>
             {errors.lastname && <p className="text-red-500 text-end">{errors.lastname.message}</p>}
       ...
       <input
            ...
            className={`border ${errors.email ? " placeholder:text-red-500" : "" } w-full relative outline-0 border-1 border-gray-500 px-3 py-3 rounded-md ${
              errors.email ? "border-red-500" : ""
            }`}
            placeholder={`${errors.email ? " example@gmail.com" : " email "}`}
            type="email"
          />
            {errors.email && <img className=" w-5 h-5 -translate-y-8 absolute right-5 " src={errorIcon} alt="" />}
       </div>
        ...
        <input
          ...
          />
          <img onClick={revealPass} className="w-5 h-5 -translate-y-8 absolute right-5" src={revealPassword} alt="" />
             {errors.password && <img className=" w-5 h-5 -translate-y-8 absolute right-5 " src={errorIcon} alt="" />}
        </div>
             {errors.password && <p className="text-red-500 text-end">{errors.password.message}</p>}
          <button type="submit" className="px-3 outline-0 py-3 rounded-md hover:bg-green-600 bg-[#38CC8C] text-white">
            {" "}
